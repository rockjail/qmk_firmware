 ...
 * |        |        | RESET  |        |        |        | P7     | P8     | P9     | -      |        |        |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | LEFT   | DOWN   | UP     | RIGHT  |        | P4     | P5     | P6     | +      |COLEMAK | QWERTY |        |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | HOME   | END    | PG UP  | PG DN  |        | P1     | P2     | P3     | PENT   |        |        | PR SCR | SCR LK | PAUSE  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        |        | ##FN## |        |        | P0     |        | P.     | PENT   |        | ##FN## |        |        |        |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { _______, _______, RESET,   _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_MINS, _______, _______, _______, _______, _______  },
  { _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, DF(_CM), DF(_QW), _______, _______, _______  },
  { _______, KC_HOME, KC_END,  KC_PGUP, KC_PGDN, _______, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, KC_PSCR, KC_SLCK, KC_PAUS  },
  { _______, _______, _______, MO(_FN), _______, _______, KC_P0,   _______, KC_PDOT, KC_PENT, _______, MO(_FN), _______, _______, _______  },
 },
 ...
 */
 ...
 [_LO] = { /* LOWER */
  ...
  { KC_DEL,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______, _______, _______, KC_CIRC, KC_MINS, KC_EQL,  KC_LPRN, KC_RPRN, _______ },
  { _______, KC_TILD, KX_DEG,  KC_PIPE, KC_GRV,  _______, _______, _______, _______, KC_BSLS, KC_AMPR, KC_ASTR, KC_LBRC, KC_RBRC, _______ },
